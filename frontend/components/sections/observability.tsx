    ...
    return (
        <section className="space-y-16 py-24 pb-40" id="observability">
            <div className="space-y-6">
                <h2 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-400">
                    Observability & Scaling
                </h2>
                <p className="max-w-4xl text-xl text-gray-300 leading-relaxed">
                    Ensuring reliability with **Horizontal Pod Autoscaling (HPA)** for load management
                    and **Kiali** for deep visibility into the Istio Service Mesh.
                </p>
            </div>
            ...
            <div className="space-y-8">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h3 className="text-3xl font-bold text-white">Horizontal Pod Autoscaling</h3>
                        <p className="text-gray-400">Automatic scaling based on CPU utilization (Target: 50%)</p>
                    </div>
                </div>
                ...
                <div className="grid gap-8 lg:grid-cols-2">
                    <GlassCard>
                        <div className="flex items-center justify-between mb-6">
                            <h4 className="text-xl font-bold text-blue-300">Staging Environment</h4>
                    ...
                    <GlassCard>
                        <div className="flex items-center justify-between mb-6">
                            <h4 className="text-xl font-bold text-purple-300">Production Environment</h4>
                            <span className="text-xs font-mono text-gray-500">Min: 2 | Max: 10</span>
                        </div>
            ...
            <div className="space-y-8 pt-12 border-t border-white/5">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h3 className="text-3xl font-bold text-white">Service Mesh Visualization (Kiali)</h3>
                        <p className="text-gray-400">Deep dive into traffic topology and mesh health.</p>
                    </div>
                </div>
